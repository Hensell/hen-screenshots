export const discoveryMessages: Record<string, readonly [string, string]> = {
  ...
  "Adds one slide to create a linked pair": [
    ...
    "Adiciona um slide para criar um par vinculado",
  ],
  "All styles": ["Todos los estilos", "Todos os estilos"],
  "Any appearance": ["Cualquier apariencia", "Qualquer aparência"],
  "Any background": ["Cualquier fondo", "Qualquer fundo"],
  "Any composition": ["Todas", "Todas"],
  Appearance: ["Apariencia", "Aparência"],
  "Apply template to": ["Aplicar plantilla a", "Aplicar modelo a"],
  "Apply to": ["Aplicar a", "Aplicar a"],
  "Apply {name}": ["Aplicar {name}", "Aplicar {name}"],
  "Back to editor": ["Volver al editor", "Voltar ao editor"],
  Background: ["Fondo", "Fundo"],
  "Best match": ["Más relevantes", "Mais relevantes"],
  "Both slides become independent. Undo anytime.": [
    "Las dos diapositivas serán independientes. Puedes deshacerlo.",
  ...
  "Choose a card to return to its editor.": [
    ...
    "Escolha um cartão para voltar ao editor.",
  ],
  "Clear filters": ["Quitar filtros", "Limpar filtros"],
  "Clear search": ["Limpiar búsqueda", "Limpar busca"],
  "Clear search & filters": [
    "Limpiar búsqueda y filtros",
    "Limpar busca e filtros",
  ],
  "Close publication preview": [
    "Cerrar vista previa de publicación",
    "Fechar prévia de publicação",
  ],
  "Close templates": ["Cerrar plantillas", "Fechar modelos"],
  Colorful: ["Colorido", "Colorido"],
  "Compact · 320 px": ["Compacta · 320 px", "Compacta · 320 px"],
  Composition: ["Composición", "Composição"],
  "Create 2-slide panorama": [
    "Crear panorama de 2 diapositivas",
    "Criar panorama de 2 slides",
  ],
  "Curated order": ["Orden recomendado", "Ordem recomendada"],
  Dark: ["Oscuro", "Escuro"],
  "Edit slide {number}": [
    "Editar diapositiva {number}",
    "Editar slide {number}",
  ],
  "Edit slide {number}: {title}": [
    "Editar diapositiva {number}: {title}",
    "Editar slide {number}: {title}",
  ],
  "Every template adapts to your project’s device and format.": [
    "Todas las plantillas se adaptan al dispositivo y formato de tu proyecto.",
    "Todos os modelos se adaptam ao dispositivo e formato do seu projeto.",
  ],
  Filters: ["Filtros", "Filtros"],
  Gradient: ["Degradado", "Degradê"],
  "Image unavailable. Replace this slide’s screenshot in the editor.": [
    "Imagen no disponible. Reemplaza la captura de esta diapositiva en el editor.",
  ...
  "Next preview screenshots": [
    ...
    "Próximas capturas da prévia",
  ],
  "Next preview slide": [
    "Siguiente diapositiva de vista previa",
    "Próximo slide da prévia",
  ],
  "Next template page": [
    "Siguiente página de plantillas",
    "Próxima página de modelos",
  ],
  ...
  "Per page": ["Por página", "Por página"],
  ...
  "Previous preview screenshots": [
    ...
    "Capturas anteriores da prévia",
  ],
  "Previous preview slide": [
    "Diapositiva anterior de vista previa",
    "Slide anterior da prévia",
  ],
  "Previous template page": [
    "Página anterior de plantillas",
    "Página anterior de modelos",
  ],
  "Project cards": ["Tarjetas de proyecto", "Cartões de projeto"],
  "Publication preview": [
  ...
  "Search names, colors, or ideas…": [
    "Busca nombres, colores o ideas…",
    "Busque nomes, cores ou ideias…",
  ],
  "Search templates": ["Buscar plantillas", "Buscar modelos"],
  Selected: ["Seleccionada", "Selecionado"],
  "Series preview pages": [
  ...
  "Showing all {count} slides. This store slot accepts up to {max} screenshots.":
    [
      ...
      "Exibindo todos os {count} slides. Esta seção da loja aceita até {max} capturas.",
    ],
  "Single slide": ["Una diapositiva", "Um slide"],
  "Slide {number}": ["Diapositiva {number}", "Slide {number}"],
  Solid: ["Sólido", "Sólido"],
  "Sort by": ["Ordenar por", "Ordenar por"],
  Style: ["Estilo", "Estilo"],
  "Swipe to see the story unfold": [
    "Desliza para descubrir la historia",
    "Deslize para descobrir a história",
  ],
  "Template filters": ["Filtros de plantillas", "Filtros de modelos"],
  "Template library": ["Biblioteca de plantillas", "Biblioteca de modelos"],
  "Template page {number}": [
    "Página de plantillas {number}",
    "Página de modelos {number}",
  ],
  "Template pages": ["Páginas de plantillas", "Páginas de modelos"],
  "Template results": ["Resultados de plantillas", "Resultados de modelos"],
  "Templates per page": ["Plantillas por página", "Modelos por página"],
  "This pair (2 slides)": ["Este par (2 diapositivas)", "Este par (2 slides)"],
  ...
  "Updates this panorama": [
    "Actualiza este panorama",
    "Atualiza este panorama",
  ],
  "Whole series ({count})": [
    "Toda la serie ({count})",
    "Toda a série ({count})",
  ...
  "{destination} preview": [
    ...
    "Prévia de {destination}",
  ],
  "{destination} screenshots. Use arrow keys or swipe to browse.": [
    "Capturas de {destination}. Usa las flechas o desliza para explorar.",
    "Capturas de {destination}. Use as setas ou deslize para navegar.",
  ],
  "{name} template": ["Plantilla {name}", "Modelo {name}"],
  "{number} of {count}: {title}": [
    "{number} de {count}: {title}",
    "{number} de {count}: {title}",
  ],
  "{range} of {count} template": [
    "{range} de {count} plantilla",
    "{range} de {count} modelo",
  ],
  "{range} of {count} templates": [
    "{range} de {count} plantillas",
    "{range} de {count} modelos",
  ],
  ...
  "A continuous backdrop and one shared device, split into two consecutive slides.":
    [
      "Un fondo continuo y un dispositivo compartido, divididos en dos diapositivas consecutivas.",
      "Um fundo contínuo e um dispositivo compartilhado, divididos em dois slides consecutivos.",
    ],
  ...
  "A fine border and generous margins let your interface speak.": [
    ...
    "Uma borda fina e margens amplas deixam sua interface falar.",
  ],
  "A framed product view and an editorial headline.": [
    "Una vista enmarcada del producto y un título editorial.",
    "Uma visualização emoldurada do produto e um título editorial.",
  ],
  "A generous product view with a bold headline.": [
    "Una vista amplia del producto con un título destacado.",
  ...
  "A little framing. Plenty of breathing room.": [
    ...
    "Uma moldura sutil. Muito espaço para respirar.",
  ],
  "A little movement. A memorable launch.": [
    "Un poco de movimiento. Un lanzamiento memorable.",
    "Um pouco de movimento. Um lançamento memorável.",
  ],
  "A little playful. Entirely yours.": [
    "Un toque divertido. Completamente tuyo.",
    "Um toque divertido. Inteiramente seu.",
  ],
  ...
  "A raised device sits to the left of a striped awning, with the headline tucked into the lower right.":
    [
      "Un dispositivo elevado se ubica a la izquierda de un toldo a rayas, con el título en la parte inferior derecha.",
      "Um dispositivo elevado fica à esquerda de um toldo listrado, com o título na parte inferior direita.",
    ],
  "A serif masthead, a fine rule and a separate caption give your work the feel of a printed feature.":
    [
      "Un encabezado con serifas, una línea fina y un texto separado dan a tu trabajo el estilo de un artículo impreso.",
      "Um cabeçalho com serifa, uma linha fina e uma legenda separada dão ao seu trabalho o estilo de uma matéria impressa.",
    ],
  "A tilted device bridges two slides over continuous, editable color waves.": [
    "Un dispositivo inclinado une dos diapositivas sobre ondas de color continuas y editables.",
  ...
  "An editorial panorama with one shared device and flowing lines that meet at the seam.":
    [
      "Un panorama editorial con un dispositivo compartido y líneas fluidas que coinciden en la unión.",
      "Um panorama editorial com um dispositivo compartilhado e linhas fluidas que se encontram na emenda.",
    ],
  ...
  "An image-led composition with a caption beneath, made for a closer look.": [
    ...
    "Uma composição centrada na imagem com legenda abaixo, feita para ver os detalhes.",
  ],
  "An inset product panel and a serif caption turn your screenshot into an editorial feature.":
    [
      "Un panel interior para el producto y un texto con serifas convierten tu captura en una pieza editorial.",
      "Um painel interno para o produto e uma legenda com serifa transformam sua captura em uma peça editorial.",
    ],
  "An open arch frames your screenshot; a serif headline brings a quieter, editorial rhythm.":
    [
      "Un arco abierto enmarca tu captura; un título con serifas aporta un ritmo editorial más tranquilo.",
  ...
  "Citrus color. An off-center point of view.": [
    ...
    "Cor cítrica. Um ponto de vista diferente.",
  ],
  ...
  "Find a new angle in the details.": [
    "Encuentra otro ángulo en los detalles.",
    "Encontre outro ângulo nos detalhes.",
  ],
  ...
  "Layered paper shapes and a gentle tilt bring energy to a launch, without getting in the way of your words.":
    [
      "Formas de papel en capas y una inclinación suave dan energía al lanzamiento sin restar protagonismo a tus palabras.",
      "Formas de papel em camadas e uma inclinação suave dão energia ao lançamento sem tirar o destaque das suas palavras.",
    ],
  "Leaf silhouettes, soft paper and a little room to grow.": [
    "Siluetas de hojas, papel suave y espacio para crecer.",
    "Silhuetas de folhas, papel suave e espaço para crescer.",
  ],
  "Let your product lead. Then make your point.": [
    "Que tu producto sea protagonista. Después, cuenta su historia.",
    "Deixe seu produto ser o protagonista. Depois, conte sua história.",
  ],
  "Make your next idea look ready.": [
    "Presenta tu próxima idea como se merece.",
    "Apresente sua próxima ideia como ela merece.",
  ],
  Mat: ["Paspartú", "Passe-partout"],
  "One device. A whole new orbit.": [
    "Un dispositivo. Una órbita nueva.",
    "Um dispositivo. Uma nova órbita.",
  ],
  "One scene. A story across two slides.": [
    "Una escena. Una historia en dos diapositivas.",
    "Uma cena. Uma história em dois slides.",
  ],
  ...
  "Quiet space. A product worth looking at.": [
    "Un espacio tranquilo. Un producto que merece atención.",
    "Um espaço tranquilo. Um produto que merece atenção.",
  ],
  Ribbon: ["Cinta", "Faixa"],
  ...
  "Sculpted fan patterns surround a diagonal device, framed by a serif headline above and supporting text below.":
    [
      "Patrones de abanicos esculpidos rodean un dispositivo diagonal, con un título con serifas arriba y texto de apoyo abajo.",
      "Padrões de leques esculpidos envolvem um dispositivo diagonal, com um título com serifa acima e texto de apoio abaixo.",
    ],
  "Sharp detail. Nothing competing with your app.": [
    "Detalles precisos. Toda la atención en tu app.",
    "Detalhes precisos. Toda a atenção no seu app.",
  ],
  "Soft color, with a thread of character.": [
  ...
  "The work comes first. The story follows.": [
    "Primero el trabajo. Después, la historia.",
    "Primeiro o trabalho. Depois, a história.",
  ],
  "Topographic lines": ["Líneas topográficas", "Linhas topográficas"],
  "Translucent planes and an angled device bring depth to your app, with every color editable.":
    [
      "Planos translúcidos y un dispositivo inclinado dan profundidad a tu app, con todos los colores editables.",
      "Planos translúcidos e um dispositivo inclinado dão profundidade ao seu app, com todas as cores editáveis.",
    ],
  "Two tones. One confident statement.": [
    "Dos tonos. Un mensaje con personalidad.",
  ...
  "color block": ["bloque de color", "bloco de cor"],
  colorful: ["colorido", "colorido"],
  contours: ["contornos", "contornos"],
  copper: ["cobre", "cobre"],
  coral: ["coral", "coral"],
  cream: ["crema", "creme"],
  "cut paper": ["papel recortado", "papel recortado"],
  damier: ["cuadriculado", "quadriculado"],
  dark: ["oscuro", "escuro"],
  desktop: ["escritorio", "desktop"],
  diagonal: ["diagonal", "diagonal"],
  dots: ["puntos", "pontos"],
  drafting: ["dibujo técnico", "desenho técnico"],
  espresso: ["café oscuro", "café escuro"],
  fans: ["abanicos", "leques"],
  fold: ["pliegue", "dobra"],
  graphite: ["grafito", "grafite"],
  green: ["verde", "verde"],
  ...
  luxury: ["lujo", "luxo"],
  midnight: ["medianoche", "meia-noite"],
  minimal: ["minimalista", "minimalista"],
  mint: ["menta", "menta"],
  ...
  pattern: ["patrón", "padrão"],
  peach: ["durazno", "pêssego"],
  petrol: ["petróleo", "petróleo"],
  pink: ["rosa", "rosa"],
  playful: ["divertido", "divertido"],
  plum: ["ciruela", "ameixa"],
  portfolio: ["portafolio", "portfólio"],
  poster: ["póster", "pôster"],
  print: ["impreso", "impresso"],
  purple: ["morado", "roxo"],
  quiet: ["tranquilo", "tranquilo"],
  red: ["rojo", "vermelho"],
  ribbon: ["cinta", "faixa"],
  ...
  sage: ["salvia", "sálvia"],
  sand: ["arena", "areia"],
  scallops: ["ondas", "ondas"],
  serif: ["serifas", "serifa"],
  simple: ["sencillo", "simples"],
  space: ["espacio", "espaço"],
  stage: ["escenario", "palco"],
  stitch: ["puntada", "ponto de costura"],
  stripes: ["rayas", "listras"],
  sunrise: ["amanecer", "amanhecer"],
  teal: ["verde azulado", "verde-azulado"],
  technical: ["técnico", "técnico"],
  terracotta: ["terracota", "terracota"],
  tilted: ["inclinado", "inclinado"],
  topographic: ["topográfico", "topográfico"],
