export const landingMessages: Record<string, readonly [string, string]> = {
  ...
  "A few of the 43 templates waiting in your studio.": [
    "Algunas de las 43 plantillas que te esperan en el estudio.",
    "Alguns dos 43 modelos que esperam por você no estúdio.",
  ],
  "A free screenshot studio for your next launch. Make app store screenshots and portfolio mockups right in your browser.":
    [
      "Un estudio de capturas gratuito para tu próximo lanzamiento. Crea capturas para tiendas de apps y mockups para tu portafolio desde el navegador.",
      "Um estúdio de capturas gratuito para seu próximo lançamento. Crie capturas para lojas de apps e mockups para seu portfólio direto no navegador.",
    ],
  "A home for your best work.": [
    "Un lugar para tu mejor trabajo.",
    "Um lugar para o seu melhor trabalho.",
  ],
  ...
  "Can I make mockups for my portfolio?": [
    "¿Puedo crear mockups para mi portafolio?",
    "Posso criar mockups para meu portfólio?",
  ],
  "Can I use this for my app store listing?": [
    "¿Puedo usarlo para la ficha de mi app en las tiendas?",
    "Posso usar nas páginas do meu app nas lojas?",
  ],
  ...
  "Create an App stores or Portfolio project. Add your PNG, JPEG, or WebP captures.":
    [
      "Crea un proyecto de Tiendas de apps o Portafolio. Agrega tus capturas PNG, JPEG o WebP.",
      "Crie um projeto de Lojas de apps ou Portfólio. Adicione suas capturas PNG, JPEG ou WebP.",
    ],
  "Create beautiful screenshots for the App Store, Google Play, and your portfolio. Templates, device frames, and full-resolution exports. Free forever, with no account or watermarks.":
    [
      "Crea capturas atractivas para App Store, Google Play y tu portafolio. Plantillas, marcos de dispositivos y exportaciones en resolución completa. Gratis para siempre, sin cuenta ni marcas de agua.",
      "Crie capturas bonitas para a App Store, o Google Play e seu portfólio. Modelos, molduras de dispositivos e exportações em resolução total. Grátis para sempre, sem conta nem marcas-d’água.",
    ],
  "Create your first series": [
    "Crea tu primera serie",
  ...
  "Free forever. No account. No watermarks.": [
    "Gratis para siempre. Sin cuenta. Sin marcas de agua.",
    "Grátis para sempre. Sem conta. Sem marcas-d’água.",
  ],
  "Free.": ["Gratis.", "Grátis."],
  "Gallery template with an oversized screenshot and editorial caption.": [
  ...
  "Have an idea?": ["¿Tienes una idea?", "Tem uma ideia?"],
  "Hen Screenshots home": [
    "Inicio de Hen Screenshots",
    "Página inicial do Hen Screenshots",
  ],
  "Hen Screenshots — Free app screenshot & mockup studio": [
    "Hen Screenshots — Estudio gratuito de capturas y mockups para apps",
  ...
  "Make something worth showing": [
    ...
    "Crie algo que queira mostrar",
  ],
  "Make these your own": ["Dales tu estilo", "Deixe com a sua cara"],
  ...
  "Split template with a warm yellow and terracotta color block.": [
    "Plantilla Split con un bloque de color amarillo cálido y terracota.",
    "Modelo Split com um bloco de cor amarelo quente e terracota.",
  ],
  ...
  "Studio template with a fine border and generous space.": [
    ...
    "Modelo Studio com uma borda fina e espaços amplos.",
  ],
  "Supported presentations": [
    "Presentaciones compatibles",
    "Apresentações compatíveis",
  ],
  "THINK OUTSIDE THE APP STORE": [
    "MÁS ALLÁ DE LAS TIENDAS DE APPS",
    "VÁ ALÉM DAS LOJAS DE APPS",
  ],
  "THOUGHTFULLY COMPOSED. UNIQUELY YOURS.": [
    "DISEÑO CUIDADO. CON TU IDENTIDAD.",
    "DESIGN CUIDADOSO. COM A SUA IDENTIDADE.",
  ],
  ...
  "YOUR NEXT LAUNCH STARTS HERE": [
    "TU PRÓXIMO LANZAMIENTO EMPIEZA AQUÍ",
  ...
  "You already did the hard part: building your app. Give it a presentation that feels just as considered.":
    [
      "Ya hiciste lo más difícil: crear tu app. Dale una presentación igual de cuidada.",
      "Você já fez a parte mais difícil: criar seu app. Dê a ele uma apresentação com o mesmo cuidado.",
    ],
